document.addEventListener('DOMContentLoaded', () => {
    ...
    const setupProject = async (project) => {
        ...
        // --- LINHA CORRIGIDA ---
        // A consulta agora busca corretamente no schema 'information_schema'
        const { data, error } = await adminClient
            .from('tables')
            .select('table_name')
            .eq('table_schema', 'public')
            .eq('table_name', 'keep_alive');
        ...
        if (data.length === 0) {
            ...
            // A criação da tabela continua a mesma, usando RPC para executar SQL bruto.
